...
%whether dissertation or thesis.
...
% Remove appendix letters
\renewcommand{\thechapter}{} 
% Optional: remove extra space reserved for chapter numbers in TOC
\addtocontents{toc}{\setlength{\cftchapnumwidth}{0em}}
\addtocontents{toc}{\setlength{\cftchapnumwidth}{0em}}
\renewcommand{\appendixname}{APPENDIX:}
\renewcommand{\thesection}{A.\arabic{section}}
\setcounter{chapter}{0} % optional, start appendix chapter numbering at 1
\setcounter{section}{0} % reset section numbering
\addtocontents{toc}{\setcounter{tocdepth}{0}}
\addtocontents{toc}{\protect\renewcommand{\protect\cftchappresnum}{}}

\chapter[\MakeTextUppercase{APPENDIX}]{APPENDIX}
\lipsum[1]
\end{appendices}
