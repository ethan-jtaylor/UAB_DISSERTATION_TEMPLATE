...
The UABdissertationclass.cls file defines all the formatting for this template, and this is auto-imported into the settings file which defines various packages and renewed commands that users may want, which is then imported into the main file which does the full compiling.
